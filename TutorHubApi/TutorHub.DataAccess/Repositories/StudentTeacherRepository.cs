...
namespace TutorHub.DataAccess.Repositories
{
    public class StudentTeacherRepository : IStudentTeacherRepository
    {
        ...
        {
            return await _context.StudentTeachers.AsNoTracking().ToListAsync();
        }
        ...
        public async Task<StudentTeacher?> GetByStudentAndTeacherIdAsync(int studentId, int teacherId, bool checkForApprove)
        {
            ...
            if (checkForApprove)
            {
                studentTeacher = await _context.StudentTeachers
                .AsNoTracking()
        ...
        {
            _context.StudentTeachers.Update(studentTeacher);
        ...
        public async Task DeleteWithSchedulesAsync(int studentTeacherId)
        {
            ...
            if (studentTeacher != null)
            {
                if (studentTeacher.Schedules != null)
                    _context.Schedules.RemoveRange(studentTeacher.Schedules);
